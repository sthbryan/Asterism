...
const styles: Record<InputVariant, string> = {
  field:
    "mt-2 w-full rounded-md border border-line bg-wash px-3 py-2 text-[13px] text-paper outline-none transition-colors placeholder:text-faint focus:border-accent focus:ring-2 focus:ring-accent/20 disabled:cursor-not-allowed disabled:opacity-50",
  compact:
